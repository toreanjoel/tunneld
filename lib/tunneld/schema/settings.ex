defmodule Tunneld.Schema.Settings do
  @moduledoc """
  ...
  def data(:encryption) do
    %{
      ...
      "description" => "View the generated encryption key used for other Tunneld nodes to get access to your resources",
      "type" => "object",
      "properties" => %{
         "encryption_key" => %{
          "type" => "string",
          "description" => "The current device encryption key",
          "readOnly" => true
        }
      },
